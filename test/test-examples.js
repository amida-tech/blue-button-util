 ...
 describe('examples', function () {
   ...
   it('datetime.modelToDate', function () {
     ...
     expect(r0).toBe('2014');
     expect(r1).toBe('2014-02');
     expect(r2).toBe('2014-02-07');
     expect(r3).toBe('2014-02-07');
   });
   ...
   it('datetime.modelToDateTime', function () {
     ...
     expect(r1).toBe('2014-02');
     expect(r2).toBe('2014-02-07');
     expect(r3).toBe('2014-02-07T12:45:04.000Z');
     expect(r4).toBe('2014-02-07T12:45:04.010Z');
   });
 });
